...
#If DEBUG Then
    Public Shared HOST1 As String = "127.0.0.1"
    Public Shared HOST2 As String = "192.168.1.24"
...
#Else
    Public Shared HOST1 As String = "%HOST1%"
        Public Shared HOST2 As String = "%HOST2%"
