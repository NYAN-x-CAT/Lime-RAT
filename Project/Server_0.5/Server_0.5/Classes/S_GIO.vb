...
Public Class S_GIO
    ...
    Public Sub New(ByVal FileLocation As String)
        ...
        Catch ex As Exception
            If Not File.Exists(Application.StartupPath & "\GIO.dat") Then
                MsgBox("Writing GIO.dat and restarting lime worm")
                File.WriteAllBytes(Application.StartupPath & "\GIO.dat", My.Resources.GIO)
